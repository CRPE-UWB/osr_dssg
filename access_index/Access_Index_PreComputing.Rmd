...
for (i in 1:length(categories)){
  ...
  for (x in 1:length(costs)){
    ...
    colnames(summary_index_user_transit)[colnames(summary_index_user_transit)=="AccessIndexGraphic"] <- paste("AI_Vis",type,cost,sep = "_")
...
###Push to RDS
Remember you have to log in throught he command line before running this chunk. 
```{r}
library("RPostgreSQL")
