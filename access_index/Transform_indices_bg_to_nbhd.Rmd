...
```{r}
# pull data from RDS
driving_index_nbhd1 <- dbGetQuery(con, "select * from clean.driving_index_nbhd")


ggplot(driving_index_nbhd1, aes(student_age_a, AI_overall)) +
  geom_point(aes(color= AI_overall_weighted_weighted_rank>66)) +
  scale_color_manual(values = c("black", "red")) +
  geom_text(aes(label=ifelse(AI_overall_weighted_weighted_rank>66,as.character(nbhd_name),'')),hjust=0.7,vjust=1, size=3) +
