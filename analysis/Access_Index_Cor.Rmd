...
```{r}
cor_tests <- colnames(dps_agg)[c(2:21,37:38)] #prepare dataframe
index_tests <- colnames(dps_agg)[23:36] #prepare things we want to loop
...
cor_tests <- colnames(dps_agg_transit)[c(3:21,23:25)] #prepare dataframe
