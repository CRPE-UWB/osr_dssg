...
data <- data %>%
  mutate( pct_lhs = less_than_hs_diploma *100/ttpop_25plus_edu,
          ...
          mnb1stQ = ifelse(AI_overall.x < 58.57,1,0), #Below_1st_Quantile
          mnbmedian = ifelse(AI_overall.x < 64.01,1,0), #Below_Median
          mnamedian = ifelse(AI_overall.x > 64.01,1,0), #Above_Median
          mna4stQ =  ifelse(AI_overall.x > 68.99,1,0)) #Above_3rd_Quantile
...
sample_comparison$sample <- 
  factor(sample_comparison$sample, 
         levels = c("Low Access", "Below Median", "Above Median", "High Access"))
```
...
student_DPS_bg <- student_DPS_bg %>%
  mutate( mnb1stQ = ifelse(AI_overall.x < 58.57,1,0), #Below_1st_Quantile
          mnbmedian = ifelse(AI_overall.x < 64.01,1,0), #Below_Median
          mnamedian = ifelse(AI_overall.x > 64.01,1,0), #Above_Median
          mna4stQ =  ifelse(AI_overall.x > 68.99,1,0)) #Above_3rd_Quantile
col = colnames(student_DPS_bg)[2:8]

student_comparison <- create_samples(student_DPS_bg)
