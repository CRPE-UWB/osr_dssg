...
```{r}
source("../Google_Analytics_Functions.R",chdir=TRUE) #note this might not read the script directly, if you get an error just open the script and run the code from there
```
