...
```{r}
source("Google_Analytics_Functions.R") #note this might not read the script directly, if you get an error just open the script and run the code from there
```
...
```{r}
write.csv(Search_Summary, "../../data/shiny_tables/google_analytics.csv")
