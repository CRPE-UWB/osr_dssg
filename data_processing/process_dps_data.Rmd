...
What we care about is neighborhoods rather than block groups, though. So we want to have a mapping from block group to neighborhood. This can be computed via the function make_block_neighborhood_table in block_neighborhood.R:
```{r}
source("block_neighborhood.R")
dfFinal <- make_block_neighborhood_table()
```
