...
```{r}
programdata_final_bgs$session_date_start <- as.Date(programdata_final_bgs$session_date_start, formate = "%Y /%m /%d")
programdata_final_bgs$session_date_end <- as.Date(programdata_final_bgs$session_date_end, formate = "%Y /%m /%d")
programdata_final_bgs$raw_days <- programdata_final_bgs$session_date_end - programdata_final_bgs$session_date_start
...
programdata_final_bgs$days <- ifelse(programdata_final_bgs$raw_week==0,programdata_final_bgs$raw_days,programdata_final_bgs$raw_weeks*5)
