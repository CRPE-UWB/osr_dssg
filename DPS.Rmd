...
write.csv(ela, file="ela.csv", row.names=FALSE)
write.csv(math, file="math.csv", row.names=FALSE)
write.csv(graduation, file="graduation.csv", row.names=FALSE)
write.csv(transportation, file="transportation.csv", row.names=FALSE)
write.csv(STARreading, file="star_reading.csv", row.names=FALSE)
write.csv(enrollment, file="enrollment.csv", row.names=FALSE)
write.csv(school_locations, file="school_locations.csv", row.names=FALSE)
write.csv(attendance, file="attendance.csv", row.names=FALSE)
write.csv(cmas, file="cmas.csv", row.names=FALSE)
write.csv(student_locations, file="student_locations.csv", row.names=FALSE)
write.csv(lang, file="lang.csv", row.names=FALSE)
write.csv(choice, file="choice.csv", row.names=FALSE)
```