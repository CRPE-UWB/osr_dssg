---
title: "Data cleaning for EOCELA"
...
get_bucket('dssg2018')
data <- s3read_using(FUN = read.csv, object = "s3://dssg2018/rawdata/DPS_EOCELA_1112-1617.csv")
```
...
Answer: yes. Let's simplify these CourseFinal names, then, to just the course name (and Part or 2, if necessary). Note that in cases when the year isn't specified, that means the exam occurred in 2012.
...
plot(data$CourseFinal, main="ELA Subjects")
