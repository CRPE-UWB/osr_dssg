...
pal_disabled <- colorBin("Greys", domain = shape_census@data$students_with_any_disability, bins = 5)
...
pal_all_races <- colorFactor(c(brewer.pal(5, "Blues")[2], 
                               brewer.pal(5, "Greens")[4], 
                               brewer.pal(5, "Purples")[3]), 
